...
/////// Normals:
                float2 node_1966 = i.uv0;
                float3 normalLocal = UnpackNormal(tex2D(_NormalMap,TRANSFORM_TEX(node_1966.rg, _NormalMap))).rgb;
...
////// Emissive:
                ...
                float4 node_8 = tex2D(_DiffuseMap,TRANSFORM_TEX(node_1966.rg, _DiffuseMap));
